  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6 transition-colors duration-500">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 900px 700px at 80% 15%, rgba(139, 92, 246, 0.45), transparent 55%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 800px 600px at 20% 85%, rgba(236, 72, 153, 0.4), transparent 55%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 700px 900px at 50% 50%, rgba(139, 92, 246, 0.3), transparent 65%)",
        }}
      />
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 text-center max-w-lg">
        ...
        <div className="space-y-5">
          <h1 className="text-5xl md:text-6xl mb-4">Sneuz</h1>

          <div className="space-y-1">
            <p className="text-xl md:text-2xl text-foreground/90">
              iOS Sleep tracker that feels{" "}
              <span className="relative inline-block font-serif italic text-2xl md:text-3xl text-foreground">
                invisible
              </span>
              .
            </p>
        ...
        <div className="flex gap-4 mt-5">
          <Button
            asChild
            size="lg"
            className="rounded-full px-8 h-12 text-base font-medium bg-primary/80 hover:bg-primary hover:drop-shadow-md hover:drop-shadow-primary text-primary-foreground border-2 border-transparent"
          >
